/*
This file for create the stream file.
...
int main()
{
    ...
    if((fp=fopen("myfileA.ts","wb"))==NULL)
    {
        return 0;
    }
    ...
    for(i1=0; i1<0xFFFF; i1++)
    {
        ...
        for(i2=0;i2<181;i2++)
        {
            str[5+i2]= (unsigned char)getRand1(1,255);
        }
        //strcrc=CRC16_isr(&str[5],181);
        strcrc=CRC16_isr(str,186);
        str[186]=HBYTE(strcrc);
        str[187]=LBYTE(strcrc);
        fwrite (str, 1, 188, fp);
        fseek(fp,188*i1,SEEK_SET);
    }
